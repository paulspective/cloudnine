...
function updateMemoryLine({ city, condition, isOffline = false, isFresh = false }) {
...
// Helper functions for offline overlay 
...
// Updated memory message for offline
function getOfflineMessage(storedState) {
